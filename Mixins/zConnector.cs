...
namespace IngameScript
{
    class zConnector
    {
        ...
        public zConnector(IMyProgrammableBlock aBlock, Dock aDock) {
        ...
        public zConnector(object aData) {
        ...
        public static ImmutableArray<MyTuple<long, long, string, Vector3D, Vector3D>> ToCollection(List<zConnector> aList) {
        ...
        public static void FromCollection(object aCollection, Dictionary<long, zConnector> aDictionary) {
